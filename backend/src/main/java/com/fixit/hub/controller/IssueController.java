...
public class IssueController {
    ...
    private final com.fixit.hub.service.ScraperService scraperService;
    ...
    @GetMapping("/issues/{id}/scraped-fixes")
    @Operation(summary = "Get scraped external verified fixes", description = "Retrieves verified resolutions collected from Stack Overflow, GitHub, and official documentation.")
    public ResponseEntity<List<ScrapedFixResponse>> getScrapedFixes(@PathVariable UUID id) {
        return ResponseEntity.ok(scraperService.getScrapedFixes(id));
    }
}
